...
<div class="my-10 container mx-auto max-w-5xl prose prose-slate">
	...
	<p>
		...
		verarbeitet. Hierbei k&ouml;nnen auch personenbezogene Daten an das Mutterunternehmen von AWS in
		die USA &uuml;bermittelt werden. Die Daten&uuml;bertragung in die USA wird auf die
		EU-Standardvertragsklauseln gest&uuml;tzt. Details finden Sie hier:
		<a
	...
	<p>
		K-7 Konzept Karlsruhe GmbH
		<br />
		Roonstra&szlig;e 23a
		<br />
		76137 Karlsruhe
	</p>
	<p>E-Mail: info@k-7.eu</p>
	<p>
	...
	<p>
		...
		gerichtlich vorgehen k&ouml;nnten. Es kann daher nicht ausgeschlossen werden, dass
